//! BMR491 DC-DC Converter simulation.
//!
//! Models a Flex BMR491 intermediate bus converter with PMBus protocol
//! using the generic [`PmBusEngine`](i2c_hil_sim::PmBusEngine). The BMR491 is a 36–75V input,
//! 9.6–12V output digital DC-DC converter.
//!
//! # Usage
//!
//! ```rust
...
//!
//! let dev = Bmr491::new(Address::new(0x30).unwrap());
...
const MFR_MODEL_DATA: &[u8] = b"BMR491";
...
/// Simulated Flex BMR491 DC-DC Converter.
///
...
impl Bmr491 {
    /// Creates a new BMR491 at the given address with POR defaults.
    ...
    /// Injects a raw input power telemetry value.
