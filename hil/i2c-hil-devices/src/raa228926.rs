//! RAA228926 Dual-Output PWM Controller simulation.
//!
//! Models a Renesas RAA228926 digital multi-phase PWM controller with PMBus
//! protocol using the generic [`PmBusEngine`](i2c_hil_sim::PmBusEngine). The RAA228926 provides two
...
//!
//! let dev = Raa228926::new(Address::new(0x61).unwrap());
...
const MFR_MODEL_DATA: &[u8] = b"RAA228926";
...
impl PmBusDevice for Raa228926 {
