...
- [ ] task-006: Create SurfaceParams struct for 3D strategies → FR-2.1
- [ ] task-007: Implement ZigzagSurfaceStrategy core loop → FR-2.1, FR-2.2, FR-2.4
- [ ] task-008: Add ball-end tool compensation to zigzag → FR-2.5
- [ ] task-009: Wire ZigzagSurfaceStrategy into process_stl → FR-2.1

### Perimeter Strategy
- [ ] task-010: Implement PerimeterStrategy basic boundary follow → FR-3.1
- [ ] task-011: Add climb/conventional cut direction parameter → FR-3.2
- [ ] task-012: Support multiple perimeter passes → FR-3.4
